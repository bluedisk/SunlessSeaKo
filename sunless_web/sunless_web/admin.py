...
class EntityForm(forms.ModelForm):
    ...
    Name_original = forms.CharField(label='원문', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '24', 'rows': '1'}))
    Name_reference = forms.CharField(label='의견', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '4'}))
    Name_papago = forms.CharField(label='파파고', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '24', 'rows': '1'}))
    Name_google = forms.CharField(label='구글', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '24', 'rows': '1'}))
    Name_translate = forms.CharField(label='번역', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '24', 'rows': '1'}))
    Name_final = forms.CharField(label='최종본', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '24', 'rows': '1'}))

    Teaser_original = forms.CharField(label='원문', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', 'rows': '1'}))
    Teaser_reference = forms.CharField(label='의견', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '4'}))
    Teaser_papago = forms.CharField(label='파파고', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', 'rows': '1'}))
    Teaser_google = forms.CharField(label='구글', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', 'rows': '1'}))
    Teaser_translate = forms.CharField(label='번역', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', 'rows': '1'}))
    Teaser_final = forms.CharField(label='최종본', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', 'rows': '1'}))

    Description_original = forms.CharField(label='원문', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
    Description_reference = forms.CharField(label='의견', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
    Description_papago = forms.CharField(label='파파고', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
    Description_google = forms.CharField(label='구글', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
    Description_translate = forms.CharField(label='번역', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
    Description_final = forms.CharField(label='최종본', help_text=TRANS_HELP, required=False, widget=forms.Textarea({"cols": '100', "rows": '8'}))
